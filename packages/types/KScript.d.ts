 ...
 */
  ...
  interface kSiteDb {
    ...
    views:KScript.Sites.TextRepository;
    layouts:KScript.Sites.TextRepository;
    htmlBlocks:KScript.Sites.MultilingualRepository;
    labels:KScript.Sites.LabelRepository;
    scripts:KScript.Sites.RoutableTextRepository;
    codes:KScript.Sites.CodeRepository;
    styles:KScript.Sites.RoutableTextRepository;
    images:KScript.Sites.ImageRepository;
    files:KScript.Sites.BinaryRepository;
 ...
 */
  ...
  interface PingResult {
    ...
    success:boolean;
    <Clone>$():PingResult;
    deconstruct(Ip:any,Time:any,Success:any):void;
  }
...
declare namespace Kooboo.Sites.EmailMarketing {
  interface KEmailMarketing {
    ...
    contactList:EmailScript.KContactList;
    recipient:EmailScript.KRecipient;
    media:EmailScript.KMedia;
    campaign:EmailScript.KCampaign;
    ...
    page:EmailScript.KPage;
    notification:EmailScript.KNotification;
    setting:EmailScript.KSetting;
    delivery:EmailScript.KDelivery;
    sendingContext:Kooboo.Sites.EmailMarketing.EmailScript.KSendContext;
    template:EmailScript.KTemplate;
    report:EmailScript.KReport;
    global:EmailScript.KGlobal;
    kEmailCheck:EmailScript.KEmailCheck;
  }
 ...
 */
  ...
  interface CodeLogStore {
    ...
    groupByFunctions:Record<string, (p1:System.String,)=>Kooboo.Data.Logging.CodeLog>;
 ...
 */
    ...
    isActionMatch(route:Kooboo.Sites.Routing.Route,actionName:string,requestPath:string,routeValues:Microsoft.AspNetCore.Routing.RouteValueDictionary):boolean;
    /** ```ts
...
``` */
    send(url:string,method:string,content?:KHttpContent,headers?:any):KHttpResponse;
  }
...
declare namespace EmailScript {
  ...
  interface KSetting {
    ...
    verifyMailFrom(MailFromSubDomain:string,Domain:string):DomainResult;
...
declare namespace KScript.Account {
  ...
  interface KSubscription {
    subscribe(request:Kooboo.Data.Models.SubscriptionRequest,isStaging?:boolean|null):Kooboo.Data.Models.Subscription;
...
declare namespace KScript.Payment.Model {
  interface UserCreditCard {
    ...
    list(isStaging?:boolean|null):Kooboo.Data.Models.Market.CCPaymentMethod[];
    delete(paymentMethodId:string,isStaging?:boolean|null):void;
    checkStatus(paymentIntentId:string,isStaging?:boolean|null):boolean;
  }
...
declare namespace Kooboo.Data.Cache {
  interface Options {
    absoluteExpiration:any|null;
    slidingExpiration:any|null;
    cascades:Cascade[];
  }
  ...
  interface Cascade {
    ...
    <Clone>$():Cascade;
    deconstruct(Key:any,RemoveChangeToken:any):void;
  }
 ...
 */
    getByFolder(folder:string):Kooboo.Sites.Models.SiteObject[];
    /** ```ts
...
declare namespace Microsoft.AspNetCore.Routing {
  interface RouteValueDictionary {
    item:any;
    comparer:any;
    count:number;
    keys:string[];
    values:any[];
    fromArray(items:any[]):RouteValueDictionary;
...
``` */
    ...
    getDiscountPrice(variantId:string,options?:KScript.Commerce.Models.DiscountPriceOptions):number|null;
...
declare namespace Kooboo.Data.Context {
  ...
  interface SlotContent {
    ...
    value:string;
    <Clone>$():SlotContent;
    deconstruct(name:any,Value:any):void;
  }
...
declare namespace Kooboo.Sites.EmailMarketing.Model {
  ...
  interface Settings {
    ...
    domains:MailDomain[];
    koobooSendServer:Kooboo.Data.Models.AWS.AwsSmtpServer;
  }
 ...
 */
    getToken(resource:string,clientId:string,secret:string,tenantId:string):Microsoft.IdentityModel.Clients.ActiveDirectory.AuthenticationResult;
  }
...
declare namespace Kooboo.Sites.Repository {
  ...
  interface RouteRepository extends ISiteRepositoryBase,Kooboo.Data.Interface.IRepository {
    ...
    changeRoute(OldRelativeUrl:string,NewRelativeUrl:string,objectId?:any|null):void;
  ...
  interface HistoryItem {
    ...
    headless:boolean;
    <Clone>$():HistoryItem;
    deconstruct(Domain:any,RelativeToRoot:any,Headless:any):void;
  }
...
declare namespace Kooboo.Mail {
  ...
  interface SqlLiteHelper {
    ...
    uTCStartdate:Date;
    getConnection():Microsoft.Data.Sqlite.SqliteConnection;
...
declare namespace Microsoft.AspNetCore.Http {
  ...
  interface HttpRequest {
    ...
    readFormAsync(cancellationToken?:any):any;
  }
  ...
  interface HttpResponse {
    ...
    hasStarted:boolean;
    onStarting(callback:(p1:System.Threading.Tasks.Task,)=>System.Object,state:any):void;
    onStarting(callback:()=>System.Threading.Tasks.Task):void;
    onCompleted(callback:(p1:System.Threading.Tasks.Task,)=>System.Object,state:any):void;
    registerForDispose(disposable:any):void;
    registerForDisposeAsync(disposable:any):void;
    onCompleted(callback:()=>System.Threading.Tasks.Task):void;
    redirect(location:string):void;
    redirect(location:string,permanent:boolean):void;
    startAsync(cancellationToken?:any):any;
    completeAsync():any;
  }
  ...
  interface ConnectionInfo {
    ...
    getClientCertificateAsync(cancellationToken?:any):any;
    requestClose():void;
  }
  ...
  interface WebSocketManager {
    ...
    acceptWebSocketAsync():any;
    acceptWebSocketAsync(subProtocol:string):any;
    acceptWebSocketAsync(acceptContext:WebSocketAcceptContext):any;
  }
  ...
  interface ISession {
    ...
    id:string;
    keys:string[];
    loadAsync(cancellationToken?:any):any;
    commitAsync(cancellationToken?:any):any;
    tryGetValue(key:string,value:any):boolean;
  ...
  interface HostString {
    ...
    fromUriComponent(uri:any):HostString;
    matchesAny(value:Microsoft.Extensions.Primitives.StringSegment,patterns:Microsoft.Extensions.Primitives.StringSegment[]):boolean;
  }
  ...
  interface PathString {
    ...
    fromUriComponent(uri:any):PathString;
    startsWithSegments(other:PathString):boolean;
    startsWithSegments(other:PathString,comparisonType:any):boolean;
    startsWithSegments(other:PathString,remaining:PathString):boolean;
    startsWithSegments(other:PathString,comparisonType:any,remaining:PathString):boolean;
    startsWithSegments(other:PathString,matched:PathString,remaining:PathString):boolean;
    startsWithSegments(other:PathString,comparisonType:any,matched:PathString,remaining:PathString):boolean;
  ...
  interface QueryString {
    ...
    fromUriComponent(uri:any):QueryString;
    create(name:string,value:string):QueryString;
    create(parameters:any[]):QueryString;
    create(parameters:any[]):QueryString;
  ...
  interface IQueryCollection {
    count:number;
    keys:string[];
    item:Microsoft.Extensions.Primitives.StringValues;
    containsKey(key:string):boolean;
    tryGetValue(key:string,value:Microsoft.Extensions.Primitives.StringValues):boolean;
  }

  interface IHeaderDictionary {
    item:Microsoft.Extensions.Primitives.StringValues;
    contentLength:number|null;
    accept:Microsoft.Extensions.Primitives.StringValues;
    acceptCharset:Microsoft.Extensions.Primitives.StringValues;
    acceptEncoding:Microsoft.Extensions.Primitives.StringValues;
    acceptLanguage:Microsoft.Extensions.Primitives.StringValues;
    acceptRanges:Microsoft.Extensions.Primitives.StringValues;
    accessControlAllowCredentials:Microsoft.Extensions.Primitives.StringValues;
    accessControlAllowHeaders:Microsoft.Extensions.Primitives.StringValues;
    accessControlAllowMethods:Microsoft.Extensions.Primitives.StringValues;
    accessControlAllowOrigin:Microsoft.Extensions.Primitives.StringValues;
    accessControlExposeHeaders:Microsoft.Extensions.Primitives.StringValues;
    accessControlMaxAge:Microsoft.Extensions.Primitives.StringValues;
    accessControlRequestHeaders:Microsoft.Extensions.Primitives.StringValues;
    accessControlRequestMethod:Microsoft.Extensions.Primitives.StringValues;
    age:Microsoft.Extensions.Primitives.StringValues;
    allow:Microsoft.Extensions.Primitives.StringValues;
    altSvc:Microsoft.Extensions.Primitives.StringValues;
    authorization:Microsoft.Extensions.Primitives.StringValues;
    baggage:Microsoft.Extensions.Primitives.StringValues;
    cacheControl:Microsoft.Extensions.Primitives.StringValues;
    connection:Microsoft.Extensions.Primitives.StringValues;
    contentDisposition:Microsoft.Extensions.Primitives.StringValues;
    contentEncoding:Microsoft.Extensions.Primitives.StringValues;
    contentLanguage:Microsoft.Extensions.Primitives.StringValues;
    contentLocation:Microsoft.Extensions.Primitives.StringValues;
    contentMD5:Microsoft.Extensions.Primitives.StringValues;
    contentRange:Microsoft.Extensions.Primitives.StringValues;
    contentSecurityPolicy:Microsoft.Extensions.Primitives.StringValues;
    contentSecurityPolicyReportOnly:Microsoft.Extensions.Primitives.StringValues;
    contentType:Microsoft.Extensions.Primitives.StringValues;
    correlationContext:Microsoft.Extensions.Primitives.StringValues;
    cookie:Microsoft.Extensions.Primitives.StringValues;
    date:Microsoft.Extensions.Primitives.StringValues;
    eTag:Microsoft.Extensions.Primitives.StringValues;
    expires:Microsoft.Extensions.Primitives.StringValues;
    expect:Microsoft.Extensions.Primitives.StringValues;
    from:Microsoft.Extensions.Primitives.StringValues;
    grpcAcceptEncoding:Microsoft.Extensions.Primitives.StringValues;
    grpcEncoding:Microsoft.Extensions.Primitives.StringValues;
    grpcMessage:Microsoft.Extensions.Primitives.StringValues;
    grpcStatus:Microsoft.Extensions.Primitives.StringValues;
    grpcTimeout:Microsoft.Extensions.Primitives.StringValues;
    host:Microsoft.Extensions.Primitives.StringValues;
    keepAlive:Microsoft.Extensions.Primitives.StringValues;
    ifMatch:Microsoft.Extensions.Primitives.StringValues;
    ifModifiedSince:Microsoft.Extensions.Primitives.StringValues;
    ifNoneMatch:Microsoft.Extensions.Primitives.StringValues;
    ifRange:Microsoft.Extensions.Primitives.StringValues;
    ifUnmodifiedSince:Microsoft.Extensions.Primitives.StringValues;
    lastModified:Microsoft.Extensions.Primitives.StringValues;
    link:Microsoft.Extensions.Primitives.StringValues;
    location:Microsoft.Extensions.Primitives.StringValues;
    maxForwards:Microsoft.Extensions.Primitives.StringValues;
    origin:Microsoft.Extensions.Primitives.StringValues;
    pragma:Microsoft.Extensions.Primitives.StringValues;
    proxyAuthenticate:Microsoft.Extensions.Primitives.StringValues;
    proxyAuthorization:Microsoft.Extensions.Primitives.StringValues;
    proxyConnection:Microsoft.Extensions.Primitives.StringValues;
    range:Microsoft.Extensions.Primitives.StringValues;
    referer:Microsoft.Extensions.Primitives.StringValues;
    retryAfter:Microsoft.Extensions.Primitives.StringValues;
    requestId:Microsoft.Extensions.Primitives.StringValues;
    secWebSocketAccept:Microsoft.Extensions.Primitives.StringValues;
    secWebSocketKey:Microsoft.Extensions.Primitives.StringValues;
    secWebSocketProtocol:Microsoft.Extensions.Primitives.StringValues;
    secWebSocketVersion:Microsoft.Extensions.Primitives.StringValues;
    secWebSocketExtensions:Microsoft.Extensions.Primitives.StringValues;
    server:Microsoft.Extensions.Primitives.StringValues;
    setCookie:Microsoft.Extensions.Primitives.StringValues;
    strictTransportSecurity:Microsoft.Extensions.Primitives.StringValues;
    tE:Microsoft.Extensions.Primitives.StringValues;
    trailer:Microsoft.Extensions.Primitives.StringValues;
    transferEncoding:Microsoft.Extensions.Primitives.StringValues;
    translate:Microsoft.Extensions.Primitives.StringValues;
    traceParent:Microsoft.Extensions.Primitives.StringValues;
    traceState:Microsoft.Extensions.Primitives.StringValues;
    upgrade:Microsoft.Extensions.Primitives.StringValues;
    upgradeInsecureRequests:Microsoft.Extensions.Primitives.StringValues;
    userAgent:Microsoft.Extensions.Primitives.StringValues;
    vary:Microsoft.Extensions.Primitives.StringValues;
    via:Microsoft.Extensions.Primitives.StringValues;
    warning:Microsoft.Extensions.Primitives.StringValues;
    webSocketSubProtocols:Microsoft.Extensions.Primitives.StringValues;
    wWWAuthenticate:Microsoft.Extensions.Primitives.StringValues;
    xContentTypeOptions:Microsoft.Extensions.Primitives.StringValues;
    xFrameOptions:Microsoft.Extensions.Primitives.StringValues;
    xPoweredBy:Microsoft.Extensions.Primitives.StringValues;
    xRequestedWith:Microsoft.Extensions.Primitives.StringValues;
    xUACompatible:Microsoft.Extensions.Primitives.StringValues;
    xXSSProtection:Microsoft.Extensions.Primitives.StringValues;
  }
  ...
  interface IResponseCookies {
    ...
    append(keyValuePairs:any,options:CookieOptions):void;
    delete(key:string):void;
    delete(key:string,options:CookieOptions):void;
  }

  interface WebSocketAcceptContext {
    subProtocol:string;
  ...
  interface IFormFileCollection extends IFormFile[] {
    item:IFormFile;
    getFile(name:string):IFormFile;
    getFiles(name:string):IFormFile[];
  }
  ...
  interface CookieOptions {
    ...
    isEssential:boolean;
    extensions:string[];
    createCookieHeader(name:string,value:string):Microsoft.Net.Http.Headers.SetCookieHeaderValue;
  }
  ...
  interface IFormFile {
    ...
    copyToAsync(target:any,cancellationToken?:any):any;
  }

  type SameSiteMode = 'None' | 'Lax' | 'Strict' | 'Unspecified';
...
declare namespace Microsoft.IdentityModel.Clients.ActiveDirectory {
  ...
  interface UserInfo {
    ...
    givenName:string;
    familyName:string;
    passwordExpiresOn:any|null;
    passwordChangeUrl:any;
...
declare namespace Kooboo.Data.Storage {
  interface VisitorLogStore {
    ...
    isActiveWeek:boolean;
    browser(logItem:Kooboo.Data.Models.VisitorLog):string;
    getPage(logItem:Kooboo.Data.Models.VisitorLog):string;
    getPageId(logItem:Kooboo.Data.Models.VisitorLog):string;
...
declare namespace Kooboo.Sites.Commerce.Condition {
  ...
  interface Item {
    ...
    value:string;
    <Clone>$():Item;
    deconstruct(Option:any,Method:any,Value:any):void;
  }
...
declare namespace Microsoft.AspNetCore.Http.Features {
...
declare namespace MimeKit {
  ...
  interface IMimeContent {
    ...
    newLineFormat:NewLineFormat|null;
    stream:any;
    open():any;
...
declare namespace Microsoft.Data.Sqlite {
  interface SqliteConnection {
    ...
    site:any;
    container:any;
    createAggregate(name:string,func:any,isDeterministic?:boolean):void;
    createAggregate(name:string,func:any,isDeterministic?:boolean):void;
    createAggregate(name:string,func:any,isDeterministic?:boolean):void;
    createAggregate(name:string,func:any,isDeterministic?:boolean):void;
    createAggregate(name:string,func:any,isDeterministic?:boolean):void;
    ...
    createAggregate(name:string,func:any,isDeterministic?:boolean):void;
    createAggregate(name:string,func:any,isDeterministic?:boolean):void;
    createAggregate(name:string,seed:any,func:any,isDeterministic?:boolean):void;
    createAggregate(name:string,seed:any,func:any,isDeterministic?:boolean):void;
    createAggregate(name:string,seed:any,func:any,isDeterministic?:boolean):void;
    createAggregate(name:string,seed:any,func:any,isDeterministic?:boolean):void;
    createAggregate(name:string,seed:any,func:any,isDeterministic?:boolean):void;
    ...
    createAggregate(name:string,seed:any,func:any,isDeterministic?:boolean):void;
    createAggregate(name:string,seed:any,func:any,isDeterministic?:boolean):void;
    createAggregate(name:string,seed:any,func:any,resultSelector:any,isDeterministic?:boolean):void;
    createAggregate(name:string,seed:any,func:any,resultSelector:any,isDeterministic?:boolean):void;
    createAggregate(name:string,seed:any,func:any,resultSelector:any,isDeterministic?:boolean):void;
    createAggregate(name:string,seed:any,func:any,resultSelector:any,isDeterministic?:boolean):void;
    createAggregate(name:string,seed:any,func:any,resultSelector:any,isDeterministic?:boolean):void;
    ...
    createAggregate(name:string,seed:any,func:any,resultSelector:any,isDeterministic?:boolean):void;
    createAggregate(name:string,seed:any,func:any,resultSelector:any,isDeterministic?:boolean):void;
    createFunction(name:string,function:any,isDeterministic?:boolean):void;
    createFunction(name:string,function:any,isDeterministic?:boolean):void;
    createFunction(name:string,function:any,isDeterministic?:boolean):void;
    createFunction(name:string,function:any,isDeterministic?:boolean):void;
    createFunction(name:string,function:any,isDeterministic?:boolean):void;
    ...
    createFunction(name:string,function:any,isDeterministic?:boolean):void;
    createFunction(name:string,function:any,isDeterministic?:boolean):void;
    createFunction(name:string,state:any,function:any,isDeterministic?:boolean):void;
    createFunction(name:string,state:any,function:any,isDeterministic?:boolean):void;
    createFunction(name:string,state:any,function:any,isDeterministic?:boolean):void;
    createFunction(name:string,state:any,function:any,isDeterministic?:boolean):void;
    createFunction(name:string,state:any,function:any,isDeterministic?:boolean):void;
    ...
    createCollation(name:string,comparison:any):void;
    createCollation(name:string,state:any,comparison:any):void;
    beginTransaction():SqliteTransaction;
    beginTransaction(deferred:boolean):SqliteTransaction;
    beginTransaction(isolationLevel:any):SqliteTransaction;
    beginTransaction(isolationLevel:any,deferred:boolean):SqliteTransaction;
    ...
    getSchema(collectionName:string,restrictionValues:string[]):any;
    beginTransaction():any;
    beginTransaction(isolationLevel:any):any;
    beginTransactionAsync(cancellationToken?:any):any;
    beginTransactionAsync(isolationLevel:any,cancellationToken?:any):any;
    closeAsync():any;
    disposeAsync():any;
    changeDatabaseAsync(databaseName:string,cancellationToken?:any):any;
    createBatch():any;
    createCommand():any;
    enlistTransaction(transaction:any):void;
    getSchemaAsync(cancellationToken?:any):any;
    getSchemaAsync(collectionName:string,cancellationToken?:any):any;
    getSchemaAsync(collectionName:string,restrictionValues:string[],cancellationToken?:any):any;
    openAsync():any;
  ...
  interface SqliteCommand {
    ...
    updatedRowSource:any;
    site:any;
    container:any;
    createParameter():SqliteParameter;
    prepare():void;
    executeReader():SqliteDataReader;
    executeReader(behavior:any):SqliteDataReader;
    executeReaderAsync():any;
    executeReaderAsync(cancellationToken:any):any;
    executeReaderAsync(behavior:any):any;
    executeReaderAsync(behavior:any,cancellationToken:any):any;
    executeNonQuery():number;
    executeScalar():any;
    cancel():void;
    createParameter():any;
    executeReader():any;
    executeReader(behavior:any):any;
    ...
    prepareAsync(cancellationToken?:any):any;
    disposeAsync():any;
    dispose():void;
    getLifetimeService():any;
    initializeLifetimeService():any;
  ...
  interface SqliteTransaction {
    ...
    dispose():void;
    disposeAsync():any;
    rollbackAsync(cancellationToken?:any):any;
    saveAsync(savepointName:string,cancellationToken?:any):any;
    rollbackAsync(savepointName:string,cancellationToken?:any):any;
    releaseAsync(savepointName:string,cancellationToken?:any):any;
    getLifetimeService():any;
    initializeLifetimeService():any;
  }

  interface SqliteParameter {
    dbType:any;
  ...
  interface SqliteDataReader {
    ...
    getFieldType(ordinal:number):any;
    ...
    getDateTime(ordinal:number):Date;
    getDateTimeOffset(ordinal:number):any;
    getTimeSpan(ordinal:number):any;
    getDecimal(ordinal:number):number;
    getDouble(ordinal:number):number;
    getFloat(ordinal:number):number;
    getGuid(ordinal:number):any;
    ...
    getBytes(ordinal:number,dataOffset:number,buffer:number[],bufferOffset:number,length:number):number;
    getChars(ordinal:number,dataOffset:number,buffer:string[],bufferOffset:number,length:number):number;
    getStream(ordinal:number):any;
    getTextReader(ordinal:number):any;
    ...
    dispose():void;
    disposeAsync():any;
    getSchemaTableAsync(cancellationToken?:any):any;
    getColumnSchemaAsync(cancellationToken?:any):any;
    getData(ordinal:number):any;
    getProviderSpecificFieldType(ordinal:number):any;
    getProviderSpecificValue(ordinal:number):any;
    getProviderSpecificValues(values:any[]):number;
    getFieldValueAsync(ordinal:number):any;
    getFieldValueAsync(ordinal:number,cancellationToken:any):any;
  ...
  interface SqliteParameterCollection {
    count:number;
    syncRoot:any;
    item:SqliteParameter;
    isFixedSize:boolean;
    isReadOnly:boolean;
    ...
    add(parameterName:string,type:SqliteType,size:number):SqliteParameter;
    add(parameterName:string,type:SqliteType,size:number,sourceColumn:string):SqliteParameter;
    addRange(values:any):void;
    addRange(values:SqliteParameter[]):void;
    addWithValue(parameterName:string,value:any):SqliteParameter;
    clear():void;
    contains(value:any):boolean;
    contains(value:SqliteParameter):boolean;
    contains(value:string):boolean;
    copyTo(array:any,index:number):void;
    copyTo(array:SqliteParameter[],index:number):void;
    indexOf(value:any):number;
    indexOf(value:SqliteParameter):number;
    indexOf(parameterName:string):number;
    insert(index:number,value:any):void;
    insert(index:number,value:SqliteParameter):void;
...
declare namespace Microsoft.Extensions.Primitives {
  interface StringSegment {
    ...
    asMemory():any;
    compare(a:StringSegment,b:StringSegment,comparisonType:any):number;
    startsWith(text:string,comparisonType:any):boolean;
    endsWith(text:string,comparisonType:any):boolean;
    substring(offset:number):string;
    substring(offset:number,length:number):string;
    subsegment(offset:number):StringSegment;
    ...
    split(chars:string[]):StringTokenizer;
  ...
  interface StringValues extends string[] {
    count:number;
    item:string;
    toArray():string[];
  ...
  interface StringTokenizer extends StringSegment[] {
  }
...
declare namespace SQLitePCL {
  interface sqlite3 {
    isInvalid:boolean;
    isClosed:boolean;
    manual_close_v2():number;
    manual_close():number;
    enable_sqlite3_next_stmt(enabled:boolean):void;
    getOrCreateExtra(f:any):any;
    dangerousGetHandle():any;
    close():void;
    dispose():void;
...
declare namespace Microsoft.Net.Http.Headers {
  interface SetCookieHeaderValue {
    name:Microsoft.Extensions.Primitives.StringSegment;
    value:Microsoft.Extensions.Primitives.StringSegment;
    expires:any|null;
    maxAge:any|null;
    domain:Microsoft.Extensions.Primitives.StringSegment;
    path:Microsoft.Extensions.Primitives.StringSegment;
    secure:boolean;
    sameSite:SameSiteMode;
    httpOnly:boolean;
    extensions:Microsoft.Extensions.Primitives.StringSegment[];
    appendToStringBuilder(builder:any):void;
    parse(input:Microsoft.Extensions.Primitives.StringSegment):SetCookieHeaderValue;
    tryParse(input:Microsoft.Extensions.Primitives.StringSegment,parsedValue:SetCookieHeaderValue):boolean;
    parseList(inputs:string[]):SetCookieHeaderValue[];
    parseStrictList(inputs:string[]):SetCookieHeaderValue[];
    tryParseList(inputs:string[],parsedValues:any):boolean;
    tryParseStrictList(inputs:string[],parsedValues:any):boolean;
  }
...
declare namespace KMarket {
  interface AirTicketResDTO {
    errorCode:number;
    errorMsg?:string;
    /** 唯一的log id，用于问题定位 */
    log_id:number;
    words_result:AirTicketWords_result;
    /** 识别结果数 */
    words_result_num:number;
  }

  interface AirTicketWords_result {
    /** 座位等级 */
    class?:string;
    /** 销售单位号 */
    agent_code?:string;
  ...
  interface AnimalResDTO {
    /**  */
    log_id:number;
    /**  */
    result?:imageClass_ResultItem[];
  }
...
银行卡类型，0:不能识别; 1: 借记卡; 2: 信用卡 */
  ...
  interface BillWords_resultItem {
    location:Location;
  ...
  interface BusinessLicenseResDTO {
    /**  */
    log_id:number;
    words_result:BusinessLicenseWords_result;
    /**  */
    words_result_num:number;
  }

  interface BusinessLicenseWords_result {
    address:WordsMessage;
    certificateNumber:WordsMessage;
    companyName:WordsMessage;
    legalPerson:WordsMessage;
    socialCreditCode:WordsMessage;
    validity:WordsMessage;
  }
  ...
  interface CovidTestAnalysisResDTO {
    errorCode:number;
    errorMsg?:string;
    /**  */
    logId:number;
  ...
  interface FaceAddOrUpdateReqDTO {
...
说明：活体检测控制 NONE: 不进行控制 LOW:较低的活体要求(高通过率 低攻击拒绝率) NORMAL: 一般的活体要求(平衡的攻击拒绝率, 通过率) HIGH: 较高的活体要求(高攻击拒绝率 低通过率) */
  ...
  interface FaceAddResDTO {
    ...
    /**  */
    cached:number;
    result:FaceAddResult;
    /**  */
    timestamp:number;
  }

  interface FaceAddResult {
    /**  */
    face_token?:string;
    location:Location;
  }

  interface FaceBaseResDTO {
    error_code:number;
    /**  */
    error_msg?:string;
    /**  */
  ...
  interface FaceGetListResDTO {
    ...
    /**  */
    cached:number;
    result:GetListRes_Result;
    /**  */
    timestamp:number;
  }

  interface FaceGetUser_Result {
    /**  */
    user_list?:User_listItem[];
  }

  interface FaceGetUserResDTO {
    error_code:number;
    /**  */
    error_msg?:string;
    /**  */
    ...
    /**  */
    cached:number;
    result:FaceGetUser_Result;
    /**  */
    timestamp:number;
  }

  interface FaceSearch_Result {
    /**  */
    face_token?:string;
    /**  */
    user_list?:User_list[];
  ...
  interface FaceSearchResDTO {
    ...
    /**  */
    cached:number;
    result:FaceSearch_Result;
  }

  interface FaceSrearchReqDTO {
    /** 可选值范围：NONE、LOW、NORMAL、HIGH
...
说明：活体检测控制 NONE: 不进行控制 LOW:较低的活体要求(高通过率 低攻击拒绝率) NORMAL: 一般的活体要求(平衡的攻击拒绝率, 通过率) HIGH: 较高的活体要求(高攻击拒绝率 低通过率) */
  ...
  interface FaceUpdate_Result {
    /**  */
    face_token?:string;
    location:Location;
  }

  interface FaceUpdateResDTO {
    error_code:number;
    /**  */
    error_msg?:string;
    /**  */
    ...
    /**  */
    cached:number;
    result:FaceUpdate_Result;
    /**  */
    timestamp:number;
  }

  interface GeneralBillResDTO {
    errorCode:number;
    errorMsg?:string;
    /**  */
    direction:number;
    ...
    log_id:number;
    /**  */
    words_result?:BillWords_resultItem[];
    /** 识别结果数，表示words_result的元素个数 */
    words_result_num:number;
  }

  interface GeneralInvoiceResDTO {
    errorCode:number;
    errorMsg?:string;
    /**  */
    direction:number;
    /**  */
    log_id:number;
    words_result:GeneralInvoiceWords_result;
    /**  */
    words_result_num:number;
  }

  interface GeneralInvoiceWords_result {
    /**  */
    ...
    city?:string;
    /**  */
    commodityAmount?:RowWord[];
    /**  */
    commodityName?:RowWord[];
    /**  */
    commodityNum?:RowWord[];
    /**  */
    commodityPrice?:RowWord[];
    /**  */
  ...
  interface GenerationImage_Basics {
    /** A text description of the desired image(s). The maximum length is 1000 characters. */
    prompt:string;
  }

  interface GenerationImageReqDTO {
    /** A text description of the desired image(s). The maximum length is 1000 characters. */
    prompt:string;
    /** The number of images to generate. Must be between 1 and 10. */
    n:number;
  ...
  interface GetListRes_Face_listItem {
    /**  */
    ctime?:string;
    /**  */
    face_token?:string;
  ...
  interface GetListRes_Result {
    /**  */
    face_list?:GetListRes_Face_listItem[];
  }

  interface GroupGetUsers_Result {
    /**  */
    user_id_list?:string[];
  }

  interface GroupGetUsersResDTO {
    error_code:number;
    /**  */
    error_msg?:string;
    /**  */
    ...
    /**  */
    cached:number;
    result:GroupGetUsers_Result;
    /**  */
    timestamp:number;
  }

  interface HandwritingResDTO {
    /**  */
    direction:number;
    /**  */
    log_id:number;
    /**  */
    words_result?:HandwritingWords_resultItem[];
    /**  */
    words_result_num:number;
  }

  interface HandwritingWords_resultItem {
    location:Location;
    chars?:Chars[];
    probability:Probability;
    /**  */
  ...
  interface IdCardBackResDTO {
    ...
    image_status?:string;
    log_id:number;
    words_result:IdCardBackWords_Result;
  }

  interface IdCardBackWords_Result {
    expiryDate:WordsMessage;
    issuingAuthority:WordsMessage;
    issuingDate:WordsMessage;
  }

  interface IdCardFrontResDTO {
    direction:number;
    risk_type?:string;
    words_result_num:number;
    idcard_number_type:number;
    image_status?:string;
    log_id:number;
    words_result:IdCardFrontWords_Result;
  }

  interface IdCardFrontWords_Result {
    name:WordsMessage;
    nation:WordsMessage;
    addres:WordsMessage;
    idnumber:WordsMessage;
    birth:WordsMessage;
    sex:WordsMessage;
  }
  ...
  interface ImageAccurateResDTO {
    ...
    log_id:number;
    /**  */
    words_result?:ImageAccurateWords_resultItem[];
    /**  */
    words_result_num:number;
  }

  interface ImageAccurateWords_resultItem {
    /**  */
    words?:string;
  }

  interface ImageAnalysisResDTO {
    errorCode:number;
    errorMsg?:string;
    direction:number;
    /**  */
  ...
  interface ImageApprovalReqDTO {
    /** need check image */
    image:string;
  }

  interface imageClass_ResultItem {
  ...
  interface ImageContentApprovalResDTO {
    /** 成功返回 0 */
    code:number;
    /** 可能性 */
    unsafe:number;
  ...
  interface ImageTranslateResDTO {
    errorCode:number;
    errorMsg?:string;
    /**  */
    error_code?:string;
  ...
  interface NumberResDTO {
    errorCode:number;
    errorMsg?:string;
    /**  */
    log_id:number;
    /**  */
    words_result?:NumberWords_resultItem[];
    /**  */
    words_result_num:number;
  }

  interface NumberWords_resultItem {
    location:Location;
    /**  */
    words?:string;
  }
  ...
  interface OnlineTaxiResDTO {
    errorCode:number;
    errorMsg?:string;
    /**  */
    log_id:number;
    words_result:OnlineTaxiWords_result;
    /**  */
    words_result_num:number;
  }

  interface OnlineTaxiWords_result {
    /**  */
  ...
  interface OpenAI_RequestDTO_AudioReqBasics {
  ...
  interface OpenAI_RequestDTO_AudioReqDTO {
    /** The audio file to transcribe, in one of these formats: mp3, mp4, mpeg, mpga, m4a, wav, or webm. */
    file:string;
    /** The audio file to transcribe, in one of these formats: mp3, mp4, mpeg, mpga, m4a, wav, or webm. */
    fileType:string;
  ...
  interface OpenAI_RequestDTO_Message {
    role:string;
    content:string;
  }

  interface OpenAI_RequestDTO_Transcription {
    /** The audio file to transcribe, in one of these formats: mp3, mp4, mpeg, mpga, m4a, wav, or webm. */
    file:string;
    /** The audio file to transcribe, in one of these formats: mp3, mp4, mpeg, mpga, m4a, wav, or webm. */
    fileType:string;
  ...
  interface OpenAI_RequestDTO_Turbo_Basics {
    /** The messages to generate chat completions */
    messages:OpenAI_RequestDTO_Message[];
  }

  interface OpenAI_RequestDTO_TurboReqDTO {
    /** The messages to generate chat completions */
    messages:OpenAI_RequestDTO_Message[];
    /** you apikey */
    apikey:string;
  ...
  interface OpenAI_ResponseDTO_AudioResDTO {
    text?:string;
  }

  interface OpenAI_ResponseDTO_Choice {
    message:OpenAI_ResponseDTO_Message;
    finish_reason?:string;
    index:number;
  }

  interface OpenAI_ResponseDTO_Message {
    role?:string;
    content?:string;
  }

  interface OpenAI_ResponseDTO_TurboResDTO {
    id?:string;
    _object?:string;
    created:number;
    model?:string;
    usage:OpenAI_ResponseDTO_Usage;
    choices?:OpenAI_ResponseDTO_Choice[];
  }

  interface OpenAI_ResponseDTO_Usage {
    prompt_tokens:number;
    completion_tokens:number;
    total_tokens:number;
  }

  interface PlantResDTO {
    /**  */
    log_id:number;
    /**  */
    result?:imageClass_ResultItem[];
  ...
  interface QrcodeResDTO {
    /**  */
    codes_result?:Codes_resultItem[];
    /**  */
  ...
  interface QuotaInvoiceResDTO {
    errorCode:number;
    errorMsg?:string;
    /**  */
    log_id:number;
    words_result:QuotalnvoiceWords_result;
    /**  */
    words_result_num:number;
  }

  interface QuotalnvoiceWords_result {
    /**  */
    city?:string;
    /**  */
    invoice_code?:string;
  ...
  interface TextContentApprovalResDTO {
    code:number;
    riskLevel?:string;
    riskCode?:string;
    details?:Detail[];
  ...
  interface TrainTicketResDTO {
    /**  */
    direction:number;
    /**  */
    log_id:number;
    words_result:TrainTicketWords_result;
    /**  */
    words_result_num:number;
  }

  interface TrainTicketWords_result {
    /** 2019年04月03日 */
    date?:string;
    /** 天津站 */
    destination_station?:string;
  ...
  interface VarationImageBasics {
    /** The image to edit. Must be a valid PNG file, less than 4MB, and square. If mask is not provided, image must have transparency, which will be used as the mask. */
    image:string;
  }

  interface VarationImageReqDTO {
    /** The image to edit. Must be a valid PNG file, less than 4MB, and square. If mask is not provided, image must have transparency, which will be used as the mask. */
    image:string;
    /** The number of images to generate. Must be between 1 and 10. */
    n:number;
  ...
  interface VATInvoiceResDTO {
    /**  */
    log_id?:string;
    words_result:VATInvoiceWords_result;
    /**  */
    words_result_num:number;
  }

  interface VATInvoiceWords_result {
    /** 否 */
    agent?:string;
    /**  */
    amountInFiguers?:string;
    ...
    commodityPrice?:RowWord[];
    /**  */
    commodityTax?:RowWord[];
    /**  */
    commodityTaxRate?:RowWord[];
    /**  */
    commodityType?:RowWord[];
    /**  */
    commodityUnit?:RowWord[];
    /**  */
    invoiceCode?:string;
    /** 2016年06月02日 */
    invoiceDate?:string;
  ...
  interface WaybillResDTO {
    errorCode:number;
    errorMsg?:string;
    /**  */
    log_id:number;
    /**  */
    words_result?:WaybillWords_resultItem[];
    /**  */
    words_result_num:number;
  }

  interface WaybillWords_resultItem {
    /**  */
    bar_code?:WordMessage[];
    image_info:Image_info;
    /**  */
    recipient_addr?:WordMessage[];
    /**  */
    recipient_name?:WordMessage[];
    /**  */
    recipient_phone?:WordMessage[];
    /**  */
    sender_addr?:WordMessage[];
    /**  */
    sender_name?:WordMessage[];
    /**  */
    sender_phone?:WordMessage[];
    /**  */
    three_segment_code?:WordMessage[];
    /**  */
    waybill_number?:WordMessage[];
  }
 ...
 */
    Animal(image?:string):AnimalResDTO;
 ...
 */
    Plant(image?:string):PlantResDTO;
  }
 ...
 */
    AddUser(body:FaceAddOrUpdateReqDTO):FaceAddResDTO;
    /** var bytes= k.file.readBinary("face.jpg")
 ...
 */
    UpdateUser(body:FaceAddOrUpdateReqDTO):FaceUpdateResDTO;
 ...
 */
    DeleteFace(userId?:string,faceToken?:string):FaceBaseResDTO;
    /** :
 ...
 */
    GetUser(userId?:string):FaceGetUserResDTO;
 ...
 */
    GetFaces(userId?:string):FaceGetListResDTO;
 ...
 */
    GetUsers(start?:number,length?:number):GroupGetUsersResDTO;
 ...
 */
    DeleteUser(userId?:string):FaceBaseResDTO;
 ...
 */
    FaceSearch(body:FaceSrearchReqDTO):FaceSearchResDTO;
  }
 ...
 */
    SiteSubmit(siteUrl?:string,baiduToken?:string,urladdress?:string[]):BaiduSubmitResDTO;
  }
 ...
 */
    check(body?:string):SpamScoreResult;
    /** 
 */
    dump():string;
    /** 
 ...
 */
    process(body?:string):SpamScoreResult;
    /** 
------ params description ------
 ...
 */
    report(body?:string):SpamScoreResult;
    /** 
------ params description ------
 ...
 */
    report_if_spam(body?:string):ReportIfSpamResult;
    /** 
------ params description ------
 ...
 */
    symbols(body?:string):SpamScoreResult;
    /** 
 */
    tell(body:TellCommandModel):BasicResult;
  }
 ...
 */
    TextTranslate(from:string,to:string,text:string):TestTranslateResDTo;
    /** var text = "这是一个中文"
 ...
 */
    ImageTranslate(image:string,from?:string,to:string):ImageTranslateResDTO;
  }
 ...
 */
    ImageFilter(image:string):ImageContentApprovalResDTO;
    /** var text = "check text"
 ...
 */
    TextFilter(txt:string,skipBidi?:string):TextContentApprovalResDTO;
  }
 ...
 */
    chat_turbo(messages:OpenAI_RequestDTO_Message[]):OpenAI_ResponseDTO_TurboResDTO;
 ...
 */
    chat_turbo(body:OpenAI_RequestDTO_TurboReqDTO):OpenAI_ResponseDTO_TurboResDTO;
 ...
 */
    chat(prompt:string):OpenAI_ResponseDTO_TurboResDTO;
 ...
 */
    image_generate(prompt:string):ImageResDTO;
 ...
 */
    image_generate(body:GenerationImageReqDTO):ImageResDTO;
 ...
 */
    image_Edit(image:string,prompt:string):ImageResDTO;
    /** var imagebyte= k.file.readBinary("strawberries.png");   
 ...
 */
    image_Edit(body:EditImageReqDTO):ImageResDTO;
 ...
 */
    image_variation(image:string):ImageResDTO;
    /** var imagebyte= k.file.readBinary("strawberries.png");
 ...
 */
    image_variation(body:VarationImageReqDTO):ImageResDTO;
 ...
 */
    transcriptions(file:string,fileType:string):OpenAI_ResponseDTO_AudioResDTO;
    /** var file=k.file.readBinary("test.mp3")
 ...
 */
    transcriptions(body:OpenAI_RequestDTO_Transcription):OpenAI_ResponseDTO_AudioResDTO;
    /** var file=k.file.readBinary("test.mp3")
 ...
 */
    translates(file:string,fileType:string):OpenAI_ResponseDTO_AudioResDTO;
    /** var file=k.file.readBinary("test.mp3")
 ...
 */
    translates(body:OpenAI_RequestDTO_AudioReqDTO):OpenAI_ResponseDTO_AudioResDTO;
  }
 ...
 */
    BankCard(image:string):BankCardResDTO;
 ...
 */
    AirTicket(image:string):AirTicketResDTO;
 ...
 */
    CovidTest(image:string):CovidTestAnalysisResDTO;
 ...
 */
    BusinessLicense(image:string):BusinessLicenseResDTO;
 ...
 */
    GeneralBill(image:string):GeneralBillResDTO;
 ...
 */
    GeneralInvoice(image:string):GeneralInvoiceResDTO;
 ...
 */
    Handwriting(image:string):HandwritingResDTO;
 ...
 */
    HealthCode(image:string):HealthCodeResDTO;
 ...
 */
    IdCardFront(image:string):IdCardFrontResDTO;
 ...
 */
    IdCardBack(image:string):IdCardBackResDTO;
 ...
 */
    ImageAccurate(image:string):ImageAccurateResDTO;
 ...
 */
    ImageAnalysis(image:string):ImageAnalysisResDTO;
 ...
 */
    Number(image:string):NumberResDTO;
 ...
 */
    OnlineTaxi(image:string):OnlineTaxiResDTO;
 ...
 */
    QrCode(image:string):QrcodeResDTO;
 ...
 */
    QuotaInvoice(image:string):QuotaInvoiceResDTO;
 ...
 */
    TaxiInvoice(image:string):TaxiInvoiceResDTO;
 ...
 */
    TrainTicket(image:string):TrainTicketResDTO;
 ...
 */
    VATInvoice(image:string):VATInvoiceResDTO;
 ...
 */
    Waybill(image:string):WaybillResDTO;
  }
